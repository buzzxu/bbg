...
- update summary layers when significant pages change
- keep provenance information aligned with the compiled evidence used
...
5. **Update summary layers** — Refresh L0, L1, or L2 summary layers when the canonical page changed materially
6. **Maintain navigation and history** — Update `docs/wiki/index.md` and append a chronological entry to `docs/wiki/log.md`
7. **Preserve attribution and provenance** — Keep frontmatter `sources` aligned with the runtime artifacts that informed the update
