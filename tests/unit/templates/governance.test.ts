...
describe("buildGovernanceManifest", () => {
  it("generates core governance files for minimal config (no repos)", () => {
    ...
    // Core + operations + wiki skills + wiki compilation skills + wiki trust skills + Hermes skills: 37 + 18 + 3 + 2 + 3 + 13 = 76
    const skillTasks = tasks.filter((t) => t.destination.startsWith("skills/"));
    expect(skillTasks).toHaveLength(76);
    ...
    expect(skillTasks.map((t) => t.destination)).toContain("skills/cross-audit/SKILL.md");
    expect(skillTasks.map((t) => t.destination)).toContain("skills/architecture-analysis/SKILL.md");
    expect(skillTasks.map((t) => t.destination)).toContain("skills/business-analysis/SKILL.md");
    expect(skillTasks.map((t) => t.destination)).toContain("skills/cross-repo-analysis/SKILL.md");
    expect(skillTasks.map((t) => t.destination)).toContain("skills/task-intake/SKILL.md");
    expect(skillTasks.map((t) => t.destination)).toContain("skills/client-delivery/SKILL.md");
    expect(skillTasks.map((t) => t.destination)).toContain("skills/task-environments/SKILL.md");
    expect(skillTasks.map((t) => t.destination)).toContain("skills/agent-observability/SKILL.md");
    expect(skillTasks.map((t) => t.destination)).toContain("skills/doc-gardening/SKILL.md");
    ...
    expect(commandTasks.map((t) => t.destination)).toContain("commands/cross-audit.md");
    expect(commandTasks.map((t) => t.destination)).toContain("commands/analyze.md");
    expect(commandTasks.map((t) => t.destination)).toContain("commands/start.md");
    expect(commandTasks.map((t) => t.destination)).toContain("commands/resume.md");
    expect(commandTasks.map((t) => t.destination)).toContain("commands/status.md");
    expect(commandTasks.map((t) => t.destination)).toContain("commands/add-repo.md");
    expect(commandTasks.map((t) => t.destination)).toContain("commands/analyze-repo.md");
    expect(commandTasks.map((t) => t.destination)).toContain("commands/task-start.md");
    expect(commandTasks.map((t) => t.destination)).toContain("commands/deliver.md");
    expect(commandTasks.map((t) => t.destination)).toContain("commands/task-env.md");
    expect(commandTasks.map((t) => t.destination)).toContain("commands/doc-garden.md");
    expect(commandTasks.map((t) => t.destination)).toContain("commands/observe.md");
    ...
    expect(destinations).toContain("commands/hermes-adopt.md");
    expect(destinations).toContain("commands/hermes-outcomes.md");
    ...
    expect(destinations).toContain("skills/hermes-strategy-adoption/SKILL.md");
    expect(destinations).toContain("skills/hermes-outcome-evaluation/SKILL.md");
  ...
  it("includes red team governance files for backend Java project", () => {
    ...
    // Total: core(231) + java(14) + backend(6) = 251
