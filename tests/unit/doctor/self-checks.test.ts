...
describe("doctor/self-checks", () => {
  ...
  it("fails the Hermes command check for a missing K9 intake command", async () => {
    const root = await makeTempDir();
    await createMinimalGovernance(root);

    const missingPath = "commands/hermes-intake.md";
    await rm(join(root, missingPath));
  ...
  it("fails the Hermes command check for a missing K9 intake review command", async () => {
    const root = await makeTempDir();
    await createMinimalGovernance(root);

    const missingPath = "commands/hermes-intake-review.md";
    await rm(join(root, missingPath));
  ...
  it("fails the Hermes command check for a missing K11 learn command", async () => {
    const root = await makeTempDir();
    await createMinimalGovernance(root);

    const missingPath = "commands/hermes-learn.md";
    await rm(join(root, missingPath));
  ...
  it("fails the Hermes command check for a missing K11 strategy command", async () => {
    const root = await makeTempDir();
    await createMinimalGovernance(root);

    const missingPath = "commands/hermes-strategy.md";
    await rm(join(root, missingPath));
  ...
  it("fails the Hermes command check for a missing K12 adopt command", async () => {
    const root = await makeTempDir();
    await createMinimalGovernance(root);

    const missingPath = "commands/hermes-adopt.md";
    await rm(join(root, missingPath));
  ...
  it("fails the Hermes command check for a missing K12 outcomes command", async () => {
    const root = await makeTempDir();
    await createMinimalGovernance(root);

    const missingPath = "commands/hermes-outcomes.md";
    await rm(join(root, missingPath));
  ...
  it("fails the Hermes skill check for a missing K9 intake skill", async () => {
    ...
    const missingPath = "skills/hermes-intake/SKILL.md";
    await rm(join(root, missingPath));
  ...
  it("fails the Hermes skill check for a missing K11 meta-learning skill", async () => {
    const root = await makeTempDir();
    await createMinimalGovernance(root);

    const missingPath = "skills/hermes-meta-learning/SKILL.md";
    await rm(join(root, missingPath));
  ...
  it("fails the Hermes skill check for a missing K11 strategy selection skill", async () => {
    const root = await makeTempDir();
    await createMinimalGovernance(root);

    const missingPath = "skills/hermes-strategy-selection/SKILL.md";
    await rm(join(root, missingPath));
  ...
  it("fails the Hermes skill check for a missing K12 strategy adoption skill", async () => {
    const root = await makeTempDir();
    await createMinimalGovernance(root);

    const missingPath = "skills/hermes-strategy-adoption/SKILL.md";
    await rm(join(root, missingPath));
  ...
  it("fails the Hermes skill check for a missing K12 outcome evaluation skill", async () => {
    const root = await makeTempDir();
    await createMinimalGovernance(root);

    const missingPath = "skills/hermes-outcome-evaluation/SKILL.md";
    await rm(join(root, missingPath));
  ...
  it("fails the Hermes doc check for a missing K11 meta-learning process doc", async () => {
    const root = await makeTempDir();
    await createMinimalGovernance(root);

    const missingPath = "docs/wiki/processes/hermes-meta-learning.md";
    await rm(join(root, missingPath));
  ...
  it("fails the Hermes doc check for a missing K12 strategy adoption process doc", async () => {
    const root = await makeTempDir();
    await createMinimalGovernance(root);

    const missingPath = "docs/wiki/processes/hermes-strategy-adoption.md";
    await rm(join(root, missingPath));
